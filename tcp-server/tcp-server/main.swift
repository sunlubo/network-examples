...
// let content = "withMemoryRebound\r\nwithCString\r\n!\r\nHTTP/1.1 200 OK\r\n\r\nhello"
// content.withCString { ptr in
//    ptr.withMemoryRebound(to: UInt8.self, capacity: content.utf8.count) { buf in
//        var used = 0
//        start: while used <= content.utf8.count {
//            let state = parse(buf.advanced(by: used), size: content.utf8.count - used)
//            switch state {
